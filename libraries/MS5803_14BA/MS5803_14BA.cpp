...
MS5803_14BA::MS5803_14BA( I2C *i2cInterfaceIn, EAddress addressIn )
...
uint32_t MS5803_14BA::GetResultCount( EResult resultTypeIn )
{
    return m_results.GetResultCount( resultTypeIn );
}

void MS5803_14BA::ClearResultCount( EResult resultTypeIn )
{
    m_results.ClearResult( resultTypeIn );
}

void MS5803_14BA::Disable()
{
...
bool MS5803_14BA::IsEnabled()
{
    return m_enabled;
}

bool MS5803_14BA::GetLock()
{
    return m_pI2C->LockAddress( m_address );
}

void MS5803_14BA::FreeLock()
{
    m_pI2C->FreeAddress( m_address );
}


EResult MS5803_14BA::SetOversampleRate( EOversampleRate rateIn )
{
...
EResult MS5803_14BA::SetWaterType( EWaterType typeIn )
{
...
uint32_t MS5803_14BA::GetUpdatePeriod()
{
...
void MS5803_14BA::Transition( EState stateIn )
{
    // Set new state
    m_state = stateIn;
}

void MS5803_14BA::DelayedTransition( EState nextState, uint32_t millisIn )
{
    // Set delay info
...
EResult MS5803_14BA::Cmd_ReadCalibrationData()
{
    uint8_t coeffs[ 2 ];
    ...
    uint8_t readCRC = ( m_coeffs[ 7 ] & 0x000F );
...
EResult MS5803_14BA::Cmd_StartPresConversion()
{
...
EResult MS5803_14BA::Cmd_StartTempConversion()
{
...
EResult MS5803_14BA::Cmd_ReadPressure()
{
    uint8_t bytes[ 3 ];
...
EResult MS5803_14BA::Cmd_ReadTemperature()
{
    uint8_t bytes[ 3 ];
...
uint8_t MS5803_14BA::CalculateCRC4()
{
...
void MS5803_14BA::ProcessData()
{
	...
	{
	    m_Ti      = 7 * ( ( int64_t )m_dT * m_dT ) / POW_2_37;
	...
	m_TEMP2 = (m_TEMP - m_Ti);
	m_P = ( ( ( ( (int64_t)m_D1 * m_SENS2 ) / POW_2_21 ) - m_OFF2 ) / POW_2_15 );
